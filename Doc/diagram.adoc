...
[%collapsible]
====
image::it4-sequence-adapt-avf-using-profile.png?raw=true[Sequence : Adapt ApartmentVaueFunction with Profile]
====

.see diagram
[%collapsible]
====
image::it4-sequence-generate-avf-profile.png?raw=true[Sequence : Generate ApartmentValueFunction using Profile]
====
