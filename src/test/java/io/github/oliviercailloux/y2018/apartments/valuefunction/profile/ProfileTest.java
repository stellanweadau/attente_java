	 ...
	 /** Inits the profile object before each tests */
	  ...
	  void initEach() {
		  ...
		  for (Criterion c : Criterion.values()) {
		      profileBuilder.setWeightRange(c, Range.range(Double.valueOf(0d), BoundType.CLOSED, Double.valueOf(10d), BoundType.CLOSED));
		    }	
	  ...
	  void profileTest() {
		  ...
		  assertEquals(Range.range(Double.valueOf(0d), BoundType.CLOSED, Double.valueOf(10d), BoundType.CLOSED), profile.getWeightRange(Criterion.NB_BEDROOMS));
	  }
