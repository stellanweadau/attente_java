...
class ApartmentTest {
	...
	@Test
	void equalsTestTrue() {
		Apartment a1 = ApartmentFactory.generateApartment(floorArea, address, nbBedrooms,
				nbSleeping, nbBathrooms, terrace, floorAreaTerrace, description, 
				title, wifi, pricePerNight, nbMinNight, tele);

		Apartment a2 = ApartmentFactory.generateApartment(floorArea, address, nbBedrooms,
				nbSleeping, nbBathrooms, terrace, floorAreaTerrace, description, 
				title, wifi, pricePerNight, nbMinNight, tele);
	...
	void equalsTestFalse() {
		Apartment a1 = ApartmentFactory.generateApartment(floorArea, "Chaville", nbBedrooms,
				nbSleeping, nbBathrooms, terrace, floorAreaTerrace, description, 
				"Marc's home", wifi, pricePerNight, nbMinNight, tele);
		Apartment a2 = ApartmentFactory.generateApartment(floorArea, "Arras", nbBedrooms,
				nbSleeping, nbBathrooms, terrace, floorAreaTerrace, description, 
				"Micky's home", wifi, pricePerNight, nbMinNight, tele);
