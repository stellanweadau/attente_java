...
/**
 * The public class LinearAVF enables to compute the subjective values of
 * apartments. This is provided by the creation of an object LinearAVF which
 * contains for each valuable attribute of an apartment : An object of and an
 * associated weight. Each Value function used are restricted to be able to deal
 * with profiles and questions
 */
public class LinearAVF {
	 ...
	 * is a LinearValueFunction or a ReversedLinearValueFunction, even if in real
	 * life it would be a discrete criteria (e.g. the number of bedrooms)
	 * <p>
	 ...
	 *
	 * @param floorAreaTerraceValueFunction the new LinearValueFunction for
	 *                                      FloorAreaTerrace
	 */
	 ...
	 *
	 * @param nbMinNightValueFunction the new ReversedLinearValueFunction for
	 *                                NbMinNight
	 */
	 ...
	 * price per night.
	 *
	 * @param pricePerNightValueFunction the new ReversedLinearValueFunction for
	 *                                   PricePerNight
	 */
