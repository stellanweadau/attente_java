...
/**
 * The public class LinearAVF enables to compute the subjective
 * values of apartments. This is provided by the creation of an object
 * LinearAVF which contains for each valuable attribute of an
 * apartment : An object of and an associated weight.
 * Each Value function used are restricted to be able to deal with profiles and questions
 */
public class LinearAVF {
    ...
    public double getSubjectiveValue(Apartment apart) {
        ...
        return ((floorAreaSubjectiveValue * getMiddleOfRange(floorAreaWeightRange)
                ...
                + getMiddleOfRange(wifiSubjectiveValueWeight) + getMiddleOfRange(pricePerNightSubjectiveValueWeight)
                + getMiddleOfRange(nbMinNightSubjectiveValueWeight) + getMiddleOfRange(teleSubjectiveValueWeight)));
