...
/**
 * This class enables the user to calculate the utility of a location by linear
 * interpolation, to have the maximum duration between the interest places.
 */
public class ValueDistFunction implements PartialValueFunction<LatLng> {
	...
	/**
	 * Add the apartment location and its utility to the HashMap and update the
	...
	/**
	 * 
	 * @return a double which corresponds to the maximum of the duration between an
	 *         interest place and the apartment.
	 */
