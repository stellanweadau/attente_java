...
public class LayoutApartmentGUI {
    ...
    /**
     * Method that creates a list of random apartments and tries them according
     * to the utility of the user
     *
    ...
    /**
     * Method that defines the action to execute when clicking on an apartment,
     * here we display some elements of the apartment
     *
