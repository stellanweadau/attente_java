...
public class LayoutApartmentGUI {
	 ...
	 * @param  listApp
	 * 				the list of apartments to display
	 * @throws DOMException
	 * @throws IllegalAccessException
	 * @throws IOException 
	 */
	 ...
	 * @param  avf
	 * 			a way to rate the apartments
	 * @throws DOMException
	 * @throws IllegalAccessException
	 * @throws IOException 
	 */
	
	public static ArrayList<Apartment> getListSorted (ApartmentValueFunction avf) throws IOException, IllegalAccessException{
