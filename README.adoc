...
* Continue the distance criteria integration according to the profesor's advice. link:https://github.com/oliviercailloux-org/projet-apartments/pull/26[(PR #26)]
