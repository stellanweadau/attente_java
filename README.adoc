...
* Continue the distance criteria integration according to the profesor's advice. link:https://github.com/oliviercailloux-org/projet-apartments/pull/24[(PR #24)]
* Reduce the redundancies in the `AVF` class to simplify the code.

==== Stellan WEA & Samy MEGUENI

* According the profesor's advice, continue the implementation of the `SpiderPlot` class. link:https://github.com/oliviercailloux-org/projet-apartments/pull/22[(PR #22)]
