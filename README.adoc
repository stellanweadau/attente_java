...
1^er^Duo : Un gui pour choisir les utilités?? (sandra et Aïssatou)et calculer les poids?? (Amir et Alexis)

2^eme^Duo : Faire le ménage dans les fonctions de génération aléatoires et corriger les tests unitaires (Laurence et Zeina)

3^eme^Duo : S'assurer que tout fonctionne bien et corriger les class paths pour les ressources (XML et images)  avec ajout des ressources images pour certaines appartement.
