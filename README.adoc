...
* For the spiderplot, taking existing data from apartments of the project instead of generating them by hand. According to your suggestion in the link:https://github.com/oliviercailloux-org/projet-apartments/pull/22[PR #22]  **(prerequisites : Improving the SpiderPlot code)**
