...
* Update the `DC_SpiderPlot` by integrating it in the `diagram-package-global`. (PR #20)
...
* Update the `SD_ValueFunction` diagram of the previous iteration according to the professor's advices. (PR #19)
* Modify the `SD_Distance` diagram from the second iteration according to the professor's advices and our 
fresh vision of the distance code. (PR #11)
