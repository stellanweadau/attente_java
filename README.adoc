...
* Trying to display the plot in another way by generating a picture instead of a swing panel.
* Working with true apartments from the project (and not generated randomly)
