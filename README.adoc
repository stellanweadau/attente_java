...
* Reduce downloads during GH actions (Fix link:https://github.com/av1m/Apartments/issues/47[#47])
...
* Reviews
* Support to teams (point to develop in the iteration according to the needs of the different teams)
