...
* Continue the distance criteria integration according to the profesor's advice.
* Reduce the redundancies in the `AVF` class to simplify the code.

==== Stellan WEA & Samy MEGUENI

* According the profesor's advice, continue the implementation of the `SpiderPlot` class. 
